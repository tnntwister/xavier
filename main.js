 ...
 * 'BEGIN:VCARD',
    'VERSION:3.0',
    'FN:gaC+l malry',
    'N;QUOTED-PRINTABLE=:malry;ga=C3=ABl;;;',
    'EMAIL;INTERNET=:gael.malry@gmail.com',
    'URL;VALUE=URI:http://www.google.com/profiles/105711626839898206618',
    'UID:2a7c9ec8-c6bf-4081-8635-04142ed7f523',
    'REV:20170904T202214Z',
    'CATEGORIES:Amis',
    'END:VCARD'
 */
...
vCard.readFile("./data/personal/Contacts-2017-10-05.vcf", function(err, json) {
	var body = [];
	var docDefinition = {
		content: [		
